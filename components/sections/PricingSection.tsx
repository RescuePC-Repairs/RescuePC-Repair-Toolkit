  ...
  return (
    <section id="pricing" className="py-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-green-500/5 rounded-full blur-3xl animate-float" style={{ animationDelay: '4s' }}></div>
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className={`text-center mb-16 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <p className="text-xl md:text-2xl text-white/90 max-w-4xl mx-auto leading-relaxed">
            Professional-grade computer repair toolkit with <strong className="text-white">military-grade security</strong> and{' '}
            <strong className="text-white">enterprise features</strong>. Trusted by Fortune 500 companies worldwide.
          </p>
        </div>

        {/* Enhanced Pricing Cards */}
        <div className={`grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16 transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            >
              ...
              <div className="space-y-4 mb-8">
                {plan.features.map((feature, featureIndex) => (
                  <div key={featureIndex} className="flex items-start gap-3 group-hover:translate-x-2 transition-transform duration-300">
              ...
              <button
                ...
                className={`w-full cta-button group relative overflow-hidden ${
                  plan.popular ? 'bg-gradient-to-r from-yellow-500 via-orange-500 to-red-500 hover:from-yellow-600 hover:via-orange-600 hover:to-red-600' : ''
                }`}
              >
                {isLoading ? (
        ...
        <div className={`grid grid-cols-1 md:grid-cols-4 gap-6 mb-12 transition-all duration-1000 delay-600 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          {[
        ...
        <div className={`mb-12 transition-all duration-1000 delay-900 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <h3 className="text-3xl font-bold text-white text-center mb-8 gradient-text">Feature Comparison</h3>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-white/10">
                    ...
                    <th className="text-center p-6 text-white font-bold bg-gradient-to-r from-yellow-500/20 to-orange-500/20">Enterprise</th>
                  </tr>
                </thead>
                <tbody>
                  {[
                    { feature: 'Multi-Platform Support', basic: '✓', pro: '✓', enterprise: '✓' },
                    { feature: 'Military-Grade Security', basic: 'Basic', pro: 'Enhanced', enterprise: 'Full' },
                    { feature: 'Automated Repairs', basic: '✗', pro: '✓', enterprise: '✓' },
                    { feature: 'Lifetime Updates', basic: '1 Year', pro: '3 Years', enterprise: 'Lifetime' },
                    { feature: 'Priority Support', basic: 'Email', pro: 'Email', enterprise: 'Phone + Email' },
                    ...
                    <tr key={index} className="border-b border-white/5 hover:bg-white/5 transition-colors duration-200">
                      ...
                      <td className="p-6 text-center text-white font-bold bg-gradient-to-r from-yellow-500/10 to-orange-500/10">{row.enterprise}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
        ...
        <div className={`transition-all duration-1000 delay-1200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <h3 className="text-3xl font-bold text-white text-center mb-8 gradient-text">Frequently Asked Questions</h3>

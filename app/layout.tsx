  ...
  return (
    <html lang="en">
      <head>
        ...
        />
        <meta httpEquiv="Content-Security-Policy" content="default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://js.stripe.com https://checkout.stripe.com https://vercel.live; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' data: https:; connect-src 'self' https://api.stripe.com https://checkout.stripe.com wss://ws.stripe.com https://vercel.live; frame-src https://js.stripe.com https://hooks.stripe.com https://checkout.stripe.com;" />
      </head>
      <body style={{ fontFamily: 'Inter, system-ui, sans-serif', backgroundColor: '#111827', color: '#ffffff', margin: 0, padding: 0 }}>
